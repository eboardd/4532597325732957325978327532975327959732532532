...
client.on('ready', async () => { 
  client.user.setActivity(`${BotConf.CustomStatus}`, { type: "STREAMING", url: "https://www.youtube.com/@justlaw154"})
      .then(console.log('Botun olan '+ client.user.tag +' Sunucuya girdi ve artık aktif!'))
...
client.login(process.env.BotConf).catch(() => console.log("ERROR - Bota giriş yapılırken başarısız olundu."));
